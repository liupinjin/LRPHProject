...
//        int colorFormat = selectColorFormat(selectCodec(mime), mime);
        ...
        MediaFormat mediaFormat = MediaFormat.createVideoFormat(mime,previewHeight, previewWidth);
        ...
        mediaFormat.setInteger(MediaFormat.KEY_COLOR_FORMAT, MediaCodecInfo.CodecCapabilities.COLOR_FormatYUV420SemiPlanar  );//设置颜色格式
...
//        //s9设备
        yuv420=rotateYUVDegree270AndMirror(input,previewWidth,previewHeight);//画面旋转镜像处理
