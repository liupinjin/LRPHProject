...
public class PopupWindowUtil {
     ...
     */
    private void submitPraise(int praiseType) {
    ...
    private void addLike(int praiseType) {
    ...
    private void deleteLike(int praiseType) {
    ...
    private void updateLike(int praiseType) {
