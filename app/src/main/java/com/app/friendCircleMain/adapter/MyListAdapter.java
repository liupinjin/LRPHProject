...
//			String  name= ob.getString("name");//name这里是列名称，获取json对象中列名为name的值
        ...
        holder.btnIgnore.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                if (1 == panelState) {
                    ...
                    switchPanelState(holder.relativeLayoutIgnore, holder.btnComment, holder
                            .btnPraise);
                } else {
            ...
            public void onClick(View v) {
                ...
                MyCustomDialog dialog = new MyCustomDialog(mContext, R.style.add_dialog, "评论" +
                    ...
                    public void back(String content) {
                        ...
                        submitComment(Constant.id, getItem(position).getPostid(), content,bean);//提交评论
                    }
                });
     ...
     * 操作面板显示状态
     */
    private void switchPanelState(RelativeLayout relaveLayoutIgnore, Button btnComment, Button
            btnPraise) {
        // TODO Auto-generated method stub
        switch (panelState) {
