...
public class VerifyCodeManager1 {
	...
	public VerifyCodeManager1(Context context, EditText editText, TextView textView) {
...
//				getVerifyCodeHandler);
	...
	private void setButtonStatusOff() {
		...
		getVerifiCodeButton.setBackgroundColor(Color.parseColor("#ffffff"));
	}

	private void setButtonStatusOn() {
		timer.cancel();
		getVerifiCodeButton.setText("重新发送");
		getVerifiCodeButton.setTextColor(Color.parseColor("#ffd340"));
		getVerifiCodeButton.setBackgroundColor(Color.parseColor("#ffffff"));
		recLen = 60;
